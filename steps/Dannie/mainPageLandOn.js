...
import { dannieContactPage,embeddedSoftwarePage,mechanicalDesignPage,page, pcbaDesignPage } from "../../globalPagesSetup.js";
...
import { BasePage } from "../../pages/BasePage.js";
         ...
         Given('user is on the main page', async function () {
            ...
            const expectedTitle = "DANNIE.CC Electronics Design and Manufacturing Services";
         ...
         Given('user able to see the Design,Manufakturing and About module on the main page', async function () {
         ...
         Given('user able to see PcbaPage under the Design module and click it', async function () {
            ...
            await page.waitForTimeout(3000);
             ...
             await page.getByRole('link', { name: 'PCBA Design', exact: true }).first().click();
         ...
         Given('user able to see MechanicalPage under the Design module and click it', async function () {
          ...
          await page.goto("https://www.dannie.cc/");
            ...
            await page.waitForTimeout(3000);
             ...
             await page.getByRole('link', { name: 'Mechanical Design', exact: true }).first().click();
         ...
         Given('user able to see EmbeddedSoftwarePage under the Design module and click it', async function () {
          ...
          await page.goto("https://www.dannie.cc/");
            ...
            await page.waitForTimeout(3000);
             ...
             await page.getByRole('link', { name: 'Embedded Software', exact: true }).first().click();
         ...
         Given('user able to see subpages of Manufakturing Module', async function () {
         ...
         Given('user able to see ComponentsSupplyPage under the Manufakturing module and click it', async function () {
            ...
            await page.waitForTimeout(3000);
             ...
             await page.getByRole('link', { name: 'Components Supply', exact: true }).first().click();
         ...
         Given('user able to see PcbAssemblPage under the Manufakturing module and click it', async function () {
           
         });

   

         Given('user able to see BoxBuildPage under the Manufakturing module and click it', async function () {
